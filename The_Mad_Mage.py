...
def choose_character():
    ...
    characters = {
        "Warrior": "The_Mad_Mage-main/images/Warrior.jpg",
        "Mage": "The_Mad_Mage-main/images/Mage.jpg",
        "Ranger": "The_Mad_Mage-main/images/Ranger.jpg",
    }
...
def display_intro():
    ...
    image_path = "The_Mad_Mage-main/images/fortress.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
...
def adventure_begins():
    ...
    image_path = "The_Mad_Mage-main/images/dungeon_image.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 200), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_first_puzzle_scene():
    ...
    image_path = "The_Mad_Mage-main/images/torch.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
...
def display_fight_scene():
    ...
    image_path = "The_Mad_Mage-main/images/stone_guardian.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_library_scene():
    ...
    image_path = "The_Mad_Mage-main/images/library.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_horned_fight_scene():
    ...
    image_path = "The_Mad_Mage-main/images/enemy.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
...
def display_new_puzzle_scene():
    ...
    # Image for the puzzle scene
    image_path = "The_Mad_Mage-main/images/tomb.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 200), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_mad_mage_battle_scene():
    ...
    image_path = "The_Mad_Mage-main/images/mad_mage.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_final_choice():
    ...
    image_path = "The_Mad_Mage-main/images/artifact.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
...
def display_congratulations_scene():
    ...
    image_path = "The_Mad_Mage-main/images/victory.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
