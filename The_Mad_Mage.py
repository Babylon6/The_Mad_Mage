...
def choose_character():
    ...
    characters = {
        "Warrior": r"D:\Code Course\Week 2\Day 5\RPG Game\warrior.jpg",
        "Mage": r"D:\Code Course\Week 2\Day 5\RPG Game\mage.jpg",
        "Ranger": r"D:\Code Course\Week 2\Day 5\RPG Game\ranger.jpg"
    }
...
def display_intro():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\fortress.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
...
def adventure_begins():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\dungeon_image.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 200), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_first_puzzle_scene():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\torch.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
...
def display_fight_scene():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\stone_guardian.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_library_scene():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\library.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_horned_fight_scene():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\enemy.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
...
def display_new_puzzle_scene():
    ...
    # Image for the puzzle scene
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\tomb.jpg"  # Replace with actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 200), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_mad_mage_battle_scene():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\mad_mage.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
    image = image.resize((400, 400), Image.Resampling.LANCZOS)  # Adjust the size as needed
    photo = ImageTk.PhotoImage(image)
    image_label = tk.Label(root, image=photo)
...
def display_final_choice():
    ...
    image_path = r"D:\Code Course\Week 2\Day 5\RPG Game\artifact.jpg"  # Replace with the actual path to your image
    image = Image.open(image_path)
